...
import featured_product_1 from "../assets/images/feature_prod_01.jpg";
import featured_product_2 from "../assets/images/feature_prod_02.jpg";
import featured_product_3 from "../assets/images/feature_prod_03.jpg";
            ...
            <div className="container py-5">
                ...
                <div className="row">
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card h-100">
                            <a href="shop-single.html">
                                <img src={featured_product_1} className="card-img-top" alt="..." />
                            </a>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card h-100">
                            <a href="shop-single.html">
                                <img src={featured_product_2} className="card-img-top" alt="..." />
                            </a>
                            <div className="card-body">
                                <ul className="list-unstyled d-flex justify-content-between">
                                    <li>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card h-100">
                            <a href="shop-single.html">
                                <img src={featured_product_3} className="card-img-top" alt="..." />
                            </a>
                            <div className="card-body">
                                <ul className="list-unstyled d-flex justify-content-between">
                                    <li>
